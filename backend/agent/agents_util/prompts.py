AGENT_PROMPTS = {
    ...
    "planning": (
        ...
        "6. MANDATORY STRUCTURE: Your response MUST be formatted EXACTLY into THREE sections using Markdown:\n\n"
        "### EXECUTION PLAN\n"
        ...
        "### VERIFICATION\n"
        "[Provide the specific commands or steps to execute in order to verify the objective and the final outcome of the experiment.\n\n]"
        "### STATUS\n"
    ...
    "safety": (
        ...
        "6. MANDATORY STRUCTURE: Your response MUST be formatted EXACTLY into these four sections using Markdown. Do NOT add any extra headers or text outside these sections:\n\n"
        "###STATUS\n"
